...
- Voice announcements are moving from the Web Speech API to **audio clips
  played through the AudioContext** (decided 2026-08-08): on iOS, speech is
  rendered on the system speech session, so with a Bluetooth speaker
